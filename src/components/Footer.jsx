  ...
  return (
    <div className='font-pop '>
        ...
        <div className='flex md:flex-row text-center md:text-left flex-col text-blue1 md:mx-10 lg:m-20 m-16 lg:gap-16 md:gap-8 gap-4 justify-center '>
            ...
            <div className='flex md:flex-row justify-center items-center flex-col lg:mx-20 lg:pb-4'>
                <div className='flex-1'>
                    <ul className='flex justify-center gap-4 pb-3 lg:p-0 flex-wrap text-blue1'>
